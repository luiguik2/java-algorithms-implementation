...
import static com.jwetherell.algorithms.ReflectUtils.compareAccess;
import static com.jwetherell.algorithms.ReflectUtils.getAnnotations;
import static com.jwetherell.algorithms.ReflectUtils.isPackageAccess;
...
import com.jwetherell.algorithms.ReflectUtils;
...
public class Reflectiontest {
    ...
    private boolean overrides(Method a, Method b) {
        return ReflectUtils.overrides(a, b);
    }

    private boolean overrides(Class<?> classA, String nameA, Class<?> classB, String nameB)
            throws NoSuchMethodException {
        return ReflectUtils.overrides(classA.getDeclaredMethod(nameA), classB.getDeclaredMethod(nameB));
    }

    private boolean overrides(Class<?> classA, Class<?> classB, String name) throws NoSuchMethodException {
    ...
    public void overridesTest() throws NoSuchMethodException {
        ...
        assertTrue("same parameters",
                overrides(I.class.getDeclaredMethod("m", char.class), H.class.getDeclaredMethod("m", char.class)));
        assertFalse("different parameters",
                overrides(I.class.getDeclaredMethod("m", char.class), H.class.getDeclaredMethod("m", long.class)));
    ...
    public void compareAccessTest() {
        ...
        assertEquals("this might as well be undefined, but it's here for posterity", 0,
                compareAccess(notModsL, notModsR));
    }
}
